            ...
            <div class="flex flex-col gap-[15px] w-full max-w-[311px]">
              ...
              <div class="flex flex-col gap-1 w-full">
                ...
                <div class="flex items-center gap-3 p-[16px_12px] border border-[#BFBFBF] rounded-xl focus-within:border-[#4D73FF] transition-all duration-300">
                  ...
                  <input type="text" class="appearance-none outline-none w-full text-sm placeholder:text-[#BFBFBF] tracking-[0.35px]" placeholder="Write your full name" name="name">
                </div>
              </div>
              <div class="flex flex-col gap-1 w-full">
                ...
                <div class="flex items-center gap-3 p-[16px_12px] border border-[#BFBFBF] rounded-xl focus-within:border-[#4D73FF] transition-all duration-300">
                  ...
                  <input type="tel" class="appearance-none outline-none w-full text-sm placeholder:text-[#BFBFBF] tracking-[0.35px]" placeholder="Your valid phone number" name="phone_number">
                </div>
              </div>
              <div class="flex flex-col gap-1 w-full">
